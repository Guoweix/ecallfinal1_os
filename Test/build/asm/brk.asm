...
/home/gwx/workspace/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/brk:     file format elf64-littleriscv
...
0000000000001328 <puts>:
{
    ...
    1330:	570000ef          	jal	18a0 <strlen>
    1334:	862a                	mv	a2,a0
    1336:	85a2                	mv	a1,s0
    1338:	4505                	li	a0,1
    133a:	14b000ef          	jal	1c84 <write>
}
    ...
    134e:	013c                	addi	a5,sp,136
{
    ...
    1566:	b6bff0ef          	jal	10d0 <printint.constprop.0>
        s += 2;
    ...
    157a:	b57ff0ef          	jal	10d0 <printint.constprop.0>
        s += 2;
    ...
    1592:	8522                	mv	a0,s0
    1594:	3f8000ef          	jal	198c <strnlen>
    write(f, s, l);
