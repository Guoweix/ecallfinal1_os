...
/home/gwx/workspace/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/gettimeofday:     file format elf64-littleriscv
...
void test_gettimeofday() {
    ...
    1030:	507000ef          	jal	1d36 <get_time>
    ...
    1058:	4df000ef          	jal	1d36 <get_time>
...
int main(void) {
	...
	test_gettimeofday();
    10d0:	f35ff0ef          	jal	1004 <test_gettimeofday>
	return 0;
}
    ...
    10e2:	05a1                	addi	a1,a1,8
{
	...
	exit(main(argc, argv));
    10e6:	fe7ff0ef          	jal	10cc <main>
    10ea:	411000ef          	jal	1cfa <exit>
	return 0;
}
...
000000000000134e <puts>:
{
    ...
    1356:	570000ef          	jal	18c6 <strlen>
    135a:	862a                	mv	a2,a0
    135c:	85a2                	mv	a1,s0
    135e:	4505                	li	a0,1
    1360:	14b000ef          	jal	1caa <write>
}
    ...
    1374:	013c                	addi	a5,sp,136
{
    ...
    158c:	b6bff0ef          	jal	10f6 <printint.constprop.0>
        s += 2;
    ...
    15a0:	b57ff0ef          	jal	10f6 <printint.constprop.0>
        s += 2;
    ...
    15b8:	8522                	mv	a0,s0
    15ba:	3f8000ef          	jal	19b2 <strnlen>
    write(f, s, l);
    15be:	0005061b          	sext.w	a2,a0
    15c2:	85a2                	mv	a1,s0
    15c4:	4505                	li	a0,1
    15c6:	6e4000ef          	jal	1caa <write>
        s += 2;
