...
/home/gwx/workspace/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/yield:     file format elf64-littleriscv
...
000000000000132e <puts>:
{
    ...
    1336:	570000ef          	jal	18a6 <strlen>
    133a:	862a                	mv	a2,a0
    133c:	85a2                	mv	a1,s0
    133e:	4505                	li	a0,1
    1340:	14b000ef          	jal	1c8a <write>
}
    ...
    1354:	013c                	addi	a5,sp,136
{
    ...
    156c:	b6bff0ef          	jal	10d6 <printint.constprop.0>
        s += 2;
    ...
    1580:	b57ff0ef          	jal	10d6 <printint.constprop.0>
        s += 2;
    ...
    1598:	8522                	mv	a0,s0
    159a:	3f8000ef          	jal	1992 <strnlen>
    write(f, s, l);
    159e:	0005061b          	sext.w	a2,a0
    15a2:	85a2                	mv	a1,s0
    15a4:	4505                	li	a0,1
    15a6:	6e4000ef          	jal	1c8a <write>
        s += 2;
